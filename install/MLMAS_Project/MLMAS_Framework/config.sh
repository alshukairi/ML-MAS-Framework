...
# ===========================
# Note: Change [ROUTES] path to:leaderboard/data/longest6/longest6.xml
# for the 36 long routes that similar to the official Carla leaderboard challange routes
export ROUTES=leaderboard/data/validation_routes/demo_routes.xml
...
export CHECKPOINT_ENDPOINT=results/demo_results.json # results file
